...
# Connect to the ARDUINO on Linux the device is mounted under /dev on windows it is as COM + number
...
class MainWindow(tk.Tk):
	...
	def set_up_window(self):
		...
		tk.Button(self, text='Toggle LED', command=lambda: self.toggle_led(LEDS.LED1)).pack()
